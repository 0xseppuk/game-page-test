...
export function OffersTableFooter() {
  return (
    <div className={styles.footer}>
      ...
      <section className={styles.footerSection}>
        <h2 className={styles.footerTitle}>Продавцам</h2>
        <p>
